 ...
 * @LastEditors: Jane
 * @LastEditTime: 2020-04-24 13:39:42
 * @Descripttion: 
 */
import * as Three from 'three';
export function makeTextSprite(message: string, message_zw: string, parameters: { [x: string]: any; hasOwnProperty?: any; } | undefined) {
 ...
 */
export function canvasTextAutoLine(str: string, canvas: any, initX: number, initY: any, lineHeight: any) {
    var ctx = canvas;
    var lineWidth = 0;
    var canvasWidth = 10;
